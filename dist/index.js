...
var NBadge = react.forwardRef(function (_a, ref) {
...
var NToggle = react.forwardRef(function (_a, ref) {
    ...
    var _j = react.useState(defaultChecked), internalChecked = _j[0], setInternalChecked = _j[1];
    ...
    var toggleElement = (jsxRuntime.jsxs("button", __assign({ ref: ref, type: "button", role: "switch", "aria-checked": checkedValue, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, disabled: disabled, id: id, className: "nkp-toggle ".concat(className), style: __assign(__assign({}, getToggleStyles(size, checkedValue, disabled, onColor, offColor, animated)), style), onClick: handleToggle, onKeyDown: handleKeyDown, onFocus: onFocus, onBlur: onBlur }, props, { children: [onText && checkedValue && (jsxRuntime.jsx("span", __assign({ style: getOnTextStyles(size) }, { children: onText }))), offText && !checkedValue && (jsxRuntime.jsx("span", __assign({ style: getOffTextStyles(size) }, { children: offText }))), jsxRuntime.jsx("span", __assign({ className: "nkp-toggle-knob", style: getKnobStyles(size, checkedValue, knobShape, knobColor, animated) }, { children: checkedValue ? onIcon : offIcon }))] })));
    if (label) {
        var labelElement = (jsxRuntime.jsx("span", __assign({ style: getLabelStyles() }, { children: label })));
        return (jsxRuntime.jsxs("div", __assign({ className: "nkp-toggle-wrapper", style: getToggleWrapperStyles() }, { children: [labelPosition === 'left' && labelElement, toggleElement, labelPosition === 'right' && labelElement] })));
    }
